        ...
        <div class="list-group shadow-sm">
          ...
          ${posts.map(post => {
            ...
            return `<a href="/post/${post._id}" class="list-group-item list-group-item-action">
                      ...
                      <span class="text-muted small">by <em>${post.author.username}</em> on ${postDate.getMonth() + 1}/${postDate.getDate()}/${postDate.getFullYear()}</span>
                    </a>`
          }).join('')}
        </div>`)
      } else {
    ...
    injectHTML() {
        ...
        <div class="search-overlay-top shadow-sm">
          <div class="container container--narrow">
            ...
            <input type="text" id="live-search-field" class="live-search-field" placeholder="Search all posts...">
